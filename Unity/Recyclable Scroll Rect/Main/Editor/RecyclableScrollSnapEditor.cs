...
public class RecyclableScrollSnapEditor : Editor
{
    ...
    RecyclableScrollSnap _script;
    protected virtual void OnEnable()
    {
        _script = (RecyclableScrollSnap)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_type.boolValue)
        {
            string title = _direction.enumValueIndex == (int)RecyclableScrollSnap.DirectionType.Vertical ? "Coloumns" : "Rows";
